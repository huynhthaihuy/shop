...
<div class="card card-primary">
  <form action="" method="POST">
    <div class="card-body">
      ...
      <div class="form-group">
        ...
        <select class="form-control" name="menu_id">
            ...
            <option value="{{$menu->id}}" {{$product->id == $menu->id ? 'selected' : ''}}>{{$menu->name}}</option>
            @endforeach
        </select>
      </div>
    ...
    <div class="form-group">
      ...
      <div>
          <a href="{{ asset('/storage/uploads/'.$product->thumb) }}" target="_blank">
              <img src="{{ asset('/storage/uploads/'.$product->thumb) }}" width="100px">
          </a>
      </div>
